...
const allBooks: GuessBook[] = [
  ...
  {
    id: 10,
    cover: 'https://picsum.photos/200/300?10',
    title: '计算机网络',
    author: '谢希仁',
    reason: '夯实基础的经典教材',
  },
  {
    id: 11,
    cover: 'https://picsum.photos/200/300?11',
    title: '操作系统真相还原',
    author: '郑钢',
    reason: '系统底层的奥秘',
  },
  {
    id: 12,
    cover: 'https://picsum.photos/200/300?12',
    title: 'Redis 深入学习',
    author: '黄亮',
    reason: '提升系统性能关键',
  },
  {
    id: 13,
    cover: 'https://picsum.photos/200/300?13',
    title: 'MySQL 性能优化',
    author: '周杰',
    reason: '数据库性能调优指南',
  },
  {
    id: 14,
    cover: 'https://picsum.photos/200/300?14',
    title: 'Python 机器学习',
    author: '吴恩达',
    reason: 'AI 工程师必修课',
  },
  {
    id: 15,
    cover: 'https://picsum.photos/200/300?15',
    title: '数据结构与算法分析',
  ...
  {
    id: 16,
    cover: 'https://picsum.photos/200/300?16',
    title: '重构：改善既有代码的设计',
  ...
  {
    id: 17,
    cover: 'https://picsum.photos/200/300?17',
    title: '设计模式之美',
    author: 'Alex Xu',
    reason: '高质量架构的关键',
  },
  {
    id: 18,
    cover: 'https://picsum.photos/200/300?18',
    title: 'Git 从入门到精通',
    author: '王者',
    reason: '版本控制实践指南',
  },
...
// 当前显示的书籍 - 明确指定类型
const books = ref<GuessBook[]>([])

// 从 allBooks 中随机抽取 N 本
function getRandomBooks(count = 6): GuessBook[] {
