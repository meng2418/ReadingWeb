package com.weread.vo.bookshelf;

import lombok.Data;
import java.time.LocalDateTime;

/**
 * Response view object for adding a book to the bookshelf (corresponds to
 * BookAddDTO).
 */
@Data
public class BookAddVO {
    // Book basic information (which the frontend may need to display the newly
    // added book)
